...
public class Jubilado_patronal extends Pension_jubilado {
    private Empresa empresa;
    private float inflacion;

    public Jubilado_patronal(String cedula, String nombre, float salario, int aniosAporte,Empresa empresa, float inflacion) {
